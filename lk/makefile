...
CFLAGS := -O2 -g -gdwarf-2 -fno-builtin -finline -W -Wall -Wno-multichar -Wno-unused-parameter -Wno-unused-function -include $(CONFIGHEADER)
#CFLAGS += -Werror
...
CFLAGS += -DMTK_KERNEL_POWER_OFF_CHARGING=yes
endif
